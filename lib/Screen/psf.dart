...
class Psf extends StatefulWidget {
  const Psf({super.key});

  @override
  State<Psf> createState() => _PsfState();
}

class _PsfState extends State<Psf> {
            ...
            children: [
              InAppWebView(
                initialUrlRequest: URLRequest(
                  url: WebUri("https://easygocms.com/autodialerapp/psf.php?adminid=123&userid=user"),
                ),
